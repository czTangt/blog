...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410201955612.png &#34;&#34;)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410202146130.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410202205123.png)

![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410202206620.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410202223241.png)

上面的状态转移图没有规定如果碰到其他的字符该怎么处理，所以下图就约定所有没有对应出边的字符默认指向 空状态 $\varnothing$，也就是  $(\Sigma \cup \{\epsilon\})$，它表示达到自身，也意味着一个死状态。 

![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410202251440.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410202317792.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410210950686.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410210952811.png)

下面就是从 NFA 到 DFA 的构造对应表，有了这张表就有了自动机。之所以是子集构造法，是因为构造出来的 DFA 对应于 NFA 的一个状态子集。同时这里因为在 NFA 中 10 是接受状态，所以在 DFA 中，对应的 E 也是接收状态。

![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410210959201.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410211050216.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410211200842.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410211203861.png)
...
![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410211302285.png)

- 最后需要注意初始划分需要考虑不同的**词法单元**。之前的划分按照接受状态和非接受状态进行划分，但是这里需要写词法分析器，所以最后的接收状态对应了不同的词法单元，所以也需要进一步划分为不同的集合。

![alt](https://nuthecz.oss-cn-hangzhou.aliyuncs.com/file/202410211304789.png)
